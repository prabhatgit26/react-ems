...
const CreateTask = () => {
    ...
    const submitHandler = (e) => {
        ...
        // console.log(taskTitle, category, taskDate, asignTo, taskDescription);
  ...
  return (
    <div className='p-5 bg-[#1c1c1c] mt-7 rounded'>
            <form onSubmit={(e)=>{submitHandler(e)}} className='flex flex-wrap w-full items-start justify-between mt-10'>
                <div className='w-1/2'>
                    <div>
